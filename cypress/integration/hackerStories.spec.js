    ...
    context('Footer and List of stories',()=>{
      ...
      context('List of stories', () => {
        ...
        it('shows the right data for all rendered stories', () => {
          ...
          // I Use a cypress command to simplify the test
          // cy.assertApidataInPosition(0)
          // cy.assertApidataInPosition(1)
        })
    ...
    context('Search', () => {
      ...
      context('Last searches', () => {
        ...
        it('shows a max of 5 buttons for the last searched terms', () => {
          ...
          //quando tem locatores muito grandes dá para utilizar esse esquema do within
